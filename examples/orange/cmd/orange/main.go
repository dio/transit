// orange is the admin CLI for the orange management plane.
//
// Usage:
//
//	orange [--server URL] [--api-key KEY] <resource> <verb> [flags]
//
// Examples (operations A1–A6 from orange-ops/06-admin-operations.md):
//
//	orange org create     --name acme
//	orange project create --org-id <id> --name project1
//	orange workspace create --project-id <id> --name workspace1
//	orange user create    --org-id <id> --email alice@acme.com
//	orange member add     --workspace-id <id> --user-id <id>
//	orange member remove  --workspace-id <id> --user-id <id>
package main
...
func usage() {
	fmt.Fprintf(os.Stderr, `orange — orange management plane CLI
...
Operations (orange-ops/06-admin-operations.md):
  ...
  Orgs:
    orange org create   --name <slug> [--description <text>]
    orange org get      --org-id <id>
    orange org list

  Projects (A1):
    orange project create  --org-id <id> --name <slug>
    orange project get     --project-id <id>
    orange project list    --org-id <id>

  Workspaces (A2):
    orange workspace create  --project-id <id> --name <slug>
    orange workspace get     --workspace-id <id>
    orange workspace list    --project-id <id>

  Users:
    orange user create  --org-id <id> --email <addr>
