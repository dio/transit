// Package main is the dynamic-module entrypoint. It blank-imports the three
// orange subpackages so their init() registrations land in the shared SDK
// registry before Envoy queries it.
package main
