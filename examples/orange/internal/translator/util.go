...
// ErrInvalidRequestBody indicates the request was parsed but contains invalid field values.
var ErrInvalidRequestBody = errors.New("invalid request body")

// jsonMarshalerFunc is the function signature compatible with encoding/json.Marshal.
type jsonMarshalerFunc = func(interface{}) ([]byte, error)
