...
import (
	...
	"github.com/dio/transit/examples/orange/internal/apischema/anthropic"
...
func buildOpenAIChatCompletionRequest(body *anthropic.MessagesRequest, modelNameOverride string) *openai.ChatCompletionRequest {
